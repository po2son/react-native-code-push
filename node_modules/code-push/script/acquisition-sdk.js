...
var AcquisitionManager = exports.AcquisitionManager = /** @class */ (function () {
    function AcquisitionManager(httpRequester, configuration) {
        ...
        this._appId = configuration.appId;
        this._baseHash = configuration.baseHash;
    }
    ...
    AcquisitionManager.prototype.queryUpdateWithCurrentPackage = function (currentPackage, callback) {
        ...
        // Use baseHash as fallback if no packageHash (first OTA diff support)
        var packageHash = currentPackage.packageHash || this._baseHash;
        var updateRequest = {
        ...
        this._httpRequester.request(0 /* Http.Verb.GET */, requestUrl, function (error, response) {
            ...
            // Copy all fields from updateInfo for future extensibility
            var remotePackage = Object.assign({}, updateInfo, {
                // Override with camelCase field names for backward compatibility
